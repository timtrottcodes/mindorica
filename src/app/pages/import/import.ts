...
Do you want to overwrite these?
  ...
  async loadDemoData() {
    ...
    await this.flashcardService.saveFlashcardsAndTopics(
      [demoQuizTopic, demoGNTopic, demoSTTopic, demoDETopic, demoDEGeneralTopic, demoBGTopic, demoBGBasicsTopic, demoBGMeetTopic, demoGBGreetingTopic, demoBGNumbersTopic, demoGBAlphabetTopic],
      demoCards
    );
